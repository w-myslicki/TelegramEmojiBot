...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="TelegramBot" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" EmojiBot %CMD_LINE_ARGS%
